...
const STRINGS: Record<string, { zh: string; en: string }> = {
  ...
  "combo.removeCombo": { zh: "删除自定义连招", en: "Delete custom combo" },
  ...
  "settings.itemKeyDuplicate": { zh: "存在重复的物品快捷键，应用时会自动分配可用键", en: "Duplicate item hotkeys will be reassigned automatically on apply" },
  "settings.itemKeyHint": { zh: "支持字母、数字、符号，以及 Mouse3/Mouse4/Mouse5 鼠标侧键", en: "Supports letters, numbers, symbols, and Mouse3/Mouse4/Mouse5 for side mouse buttons" },
  ...
  "settings.aghsScepter": { zh: "阿哈利姆神杖", en: "Aghanim's Scepter" },
  "settings.aghsOrb": { zh: "神杖强化元素", en: "Aghanim's chosen orb" },
  "settings.orbPoints": { zh: "已分配球点数", en: "Orb points allocated" },
